...
from ..anthropic_messages import AnthropicMessagesTransport, StreamChunkMode
from ..base import ProviderConfig
from ..defaults import OPENROUTER_DEFAULT_BASE
...
class OpenRouterProvider(AnthropicMessagesTransport):
    ...
    def _extract_model_ids_from_model_list_payload(
        ...
        """Only advertise OpenRouter models that can run Code Assistant tools."""

...
### Reporting Bugs
1. Check if the bug has already been reported in [Issues](https://github.com/DrAbdulmalek/bilingual-extractor/issues)
...
## Questions?
Feel free to open a [Discussion](https://github.com/DrAbdulmalek/bilingual-extractor/discussions) or reach out via Issues.

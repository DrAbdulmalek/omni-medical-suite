...
class OnlineLearner:
    ...
    def _save_memory(self, path: Path | None = None):
        """حفظ ذاكرة التصحيحات."""
    ...
    def _save_checkpoint(self, path: Path | None = None):
...
class AdaptiveLearningPipeline:
    ...
    def __init__(
        ...
        # Callbacks
        self.on_training_complete: Callable | None = None
        self.on_model_updated: Callable | None = None

...
**Parse engine merged into omni-medical-suite/backend/parsers/**
...
| Field | Value |
|-------|-------|
| **Role** | Fork / Study Repository |
| **Status** | Archived (Study Complete) |
...
This is a **fork** of [OmniParse](https://github.com/adithya-s-k/omniparse) — the open-source omni-modal parser for unstructured data. It is kept for reference and study purposes related to medical OCR enhancement.

## Changes from Upstream

| Category | Description |
|----------|-------------|
| Analysis | Studied parsing approaches for medical documents |
| Evaluation | Benchmarked on Arabic medical handwriting samples |
| Adaptation | Explored integration paths with medical-ocr-postprocessor |

## Who Should Use This

- Developers wanting to **understand** OmniParse's architecture
- Researchers exploring **multi-modal parsing** for medical documents
- Contributors wanting to **compare** parsing approaches

...
**AI Assistant pulls:** `osint-methodology` §7 Stage 1 + arsenal §16.21 (WHOIS) + §16.22 (DNS) + §28.1 (BGP).
...
**AI Assistant pulls:** `osint-methodology` §7.5 priority order + §22 breach × identity correlation + arsenal §15.
...
**AI Assistant pulls:** `osint-methodology` §31.1 exec summary template + §31.3 risk translation matrix.

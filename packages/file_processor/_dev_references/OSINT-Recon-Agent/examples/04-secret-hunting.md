...
**AI Assistant pulls:** `offensive-osint` §17 (catalog row 1 — AWS_ACCESS_KEY) + `osint-methodology` §6.3 (validator discipline).
...
**AI Assistant pulls:** `offensive-osint` §23.2 (AWS validator) + `osint-methodology` §6.3 (validator discipline).
...
**AI Assistant pulls:** `osint-methodology` §11.8 + `offensive-osint` §22.7 (AWS account-ID extraction).
...
**AI Assistant pulls:** `offensive-osint` §23.12 (post-discovery enumeration workflows — AWS).
...
**AI Assistant pulls:** `osint-methodology` §31.2 (per-finding template).

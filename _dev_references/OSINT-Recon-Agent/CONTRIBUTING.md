...
| **HIGH** | Modern secret patterns | New API key formats from any service (Linear, Loops, Resend, AI Provider Workspace, Vercel deployment tokens, etc.) |
...
4. **Run the smoke tests** locally:
   - Install the modified skill in AI Code or attach to a AI Platform project.

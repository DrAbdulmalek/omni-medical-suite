...
The skills include a **soft scope-check** that triggers when a user asks AI Assistant to act against an unverified third-party target:
...
- A trigger phrase that causes AI Assistant to attempt active exploitation despite the OSINT-only scope.

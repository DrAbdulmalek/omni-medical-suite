...
**AI Assistant pulls:** `osint-methodology` §10 (bug-bounty pivot mode) + §30.1 (HackerOne basics).
...
**AI Assistant pulls:** `osint-methodology` §7.6 (1-day standard profile) + §7.5 (priority order) + §10.1 (medium-org tactics).
...
**AI Assistant pulls:** `osint-methodology` §8.5 (asset-level triage rules) + §7.5 (priority order).
...
**AI Assistant pulls:** `offensive-osint` §20 (endpoint interest score), §39 (attack-path hints), §40 (severity matrix).
...
**AI Assistant pulls:** `osint-methodology` §6.3 (validator discipline) + §28.3 (validation discipline for vuln finds).
...
**AI Assistant pulls:** `osint-methodology` §30.2 (report structure) + §30.3 (severity inference).

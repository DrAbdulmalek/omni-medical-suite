...
class BilingualDataPipeline:
    ...
    def __init__(self, output_dir: str | Path = "output", temp_dir: str | Path | None = None):
        """
    ...
    def process_book(self, book_path: str | Path, book_name: str | None = None) -> dict[str, Any]:
        """
    ...
    def process_directory(self, input_dir: str | Path) -> list[dict[str, Any]]:
        """
...
def process_bilingual(input_path: str | Path, output_dir: str = "output") -> list[dict[str, Any]]:
    """

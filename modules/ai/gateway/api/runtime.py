...
if TYPE_CHECKING:
    ...
    from messaging.handler import AssistantMessageHandler
...
class AppRuntime:
    ...
    async def startup(self) -> None:
        logger.info("Starting OmniFile AI Gateway...")
    ...
    async def _start_message_handler(self) -> None:
        ...
        data_path = os.path.abspath(self.settings.assistant_workspace)
        ...
        plans_dir_abs = os.path.abspath(
            os.path.join(self.settings.assistant_workspace, "plans")
        )
        ...
        self.cli_manager = CLISessionManager(
            ...
            claude_bin=self.settings.assistant_cli_bin,
        ...
        self.message_handler = AssistantMessageHandler(
            platform=platform,
